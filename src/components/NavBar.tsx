...
export default function NavBar() {
   ...
   function getUserSettings() {
        if (!user) {
            return (
            <Link to="/logIn" className="button my-color-bg">
                Log in
            </Link>
            );
        } else {
                ...
                <div className="navbar-item has-dropdown is-hoverable">
                    ...
                    <div className="navbar-dropdown">
                        <div className="navbar-item">
                            <Link className="my-color" to={"/account"}>
                                Account
                            </Link>
                        </div>
                        <div className="navbar-item">
                            <Link className="my-color" to="/editRecipe">
                                Create Recipe
                            </Link>
                        </div>
                        <div className="navbar-item">
                            <Link className="my-color" to={"/myRecipes"}>
                                My Recipes
                            </Link>
                        </div>
                        <div className="navbar-item">
                            <Link className="my-color" to={"/myCollections"}>
                                Collections
                            </Link>
                        </div>
                        <div className="navbar-item is-selected">
                        <a className="my-color has-text-weight-medium" onClick={handleLogOut}>
                            Log out
                        </a>
                        </div>
                    </div>
